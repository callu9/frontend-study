...
| `delete` | 프로퍼티 삭제 | [10.8. 프로퍼티 삭제](./10_object_literal#108-프로퍼티-삭제) |
| `new` | 생성자 함수를 호출할 때 사용하여 인스턴스를 생성 | [17.2.6. new 연산자](./17_object_by_constructor_function#1726-new-연산자) |
